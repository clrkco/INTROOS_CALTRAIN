...
public class TrainSemaphores implements Runnable
{
    ...
    private final StationSemaphores[] TRAIN_STATIONS;
    private ArrayList<RobotSemaphores> TRAIN_PASSENGERS;
    private ArrayList<RobotSemaphores> TRAIN_DROPOFFS;
    private int TRAIN_WHERE;
    private int trainID;

    public TrainSemaphores(Semaphore TRAIN_AVAILABLESEATS, int TRAIN_NOOFSEATS, String TRAIN_NAME, StationSemaphores[] TRAIN_STATIONS, int id)
    {
    ...
    public void AddPassenger(RobotSemaphores passenger)
    {
    ...
    public void setTRAIN_NOOFPASSENGERS(int TRAIN_NOOFPASSENGERS)
    {
        ...
        StatusSemaphores.trainSeats.get(this.getTrainID()).setText(this.getTRAIN_NOOFPASSENGERS() + "/" + this.getTRAIN_NOOFSEATS());
    }
